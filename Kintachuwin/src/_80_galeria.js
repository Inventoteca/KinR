...
const Item = (props) => {
    return (
        <View style={{ margin: 12 }}>
            <Imgn source={props.foto} width={340} />
            <Text style={{ fontSize: 16, fontFamily: 'OpenSans-Light', /*width:100,*/ }}>
                {props.autor}
            </Text>
            <Text style={{ fontSize: 16, fontFamily: 'OpenSans-Regular', marginTop: 0, marginBottom: 0, /*width:150*/ }}>
                {props.texto}
            </Text>
        </View>
    );
...
function Galeria({ navigation }) {
    return (
        <SafeAreaView style={{
            ...
            <FlatList
                //style={{ flex:1, /*flexWrap:'wrap',*/ /*flexDirection:'row',*/ /*padding: 24*/ }}
                //numColumns={2}
                //horizontal={true}
                contentContainerStyle={{ padding: 24, /*flexDirection:'row',*/ /*flexWrap:'wrap',*/ }}
                data={DATA}
